/**
 * @author DEVANSH ANHAL(U101116FCS031
 * 	   and HARSHA DEURI (U101116FCS043)
 */
package server;
...
import javax.swing.JTextArea; // This package is imported to make a GUI
...
//							//JOptionPane.showMessageDialog(null, "No Name of the online users matches this name : "+ data[3] +"\n Check the online users correctly ", "This user is not found or not online", JOptionPane.ERROR_MESSAGE);
    ...
    public ServerWithGUI() 					// using inbuilt methods ( windows builder tools and swing)
    {
    ...
    private void b_endActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b_endActionPerformed
        try 
        {
           // Thread.sleep(500);                 //This will create a pause in between
            ta_chat.append("\n");
            ta_chat.append("\n");
            ta_chat.append("\n");
            ta_chat.append("\n");
